...
public class SimpleExample extends SimpleExampleBase{
  ...
  public SimpleExample(){
    obj = new Plane();
    //obj = new Cylinder2(32,0.6f,0.7f,true, new Vec4(1f,0f,1f,1f));
    //obj = new GridPlane(10,10,0.7f,0.9f, new Vec4(1f,0f,0f,1f));
    mats = new PMVMatrix();
  ...
  public void init(GLAutoDrawable drawable){
    ...
    gl.glUniform3f(uniformLight, 0f, 0f, 1f);
  ...
  public static void main(String[] args){
    SimpleExampleBase t = new SimpleExample();
    t.start();
  }
