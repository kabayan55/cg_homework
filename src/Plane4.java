...
public class Plane4 extends Object3D{
    //黄金比*0.4
    float k = 0.4f*((1.0f+(float)Math.sqrt(5.0))/2.0f);
    
  private final float[] VertexData = new float[]{
       0f, -0.4f,    -k,     0f, -0.4f,   - k,   1f,1f,0f,1f,        0f,1f, //#0 
       0f,  0.4f,    -k,     0f,  0.4f,    -k,   1f,1f,0f,1f,        1f,1f, //#1
       0f, -0.4f,     k,     0f, -0.4f,     k,   1f,1f,0f,1f,           1f,0f, //#2
       0f,  0.4f,     k,     0f,  0.4f,     k,   1f,1f,0f,1f,       0f,0f, //#3
       -k,    0f, -0.4f,    -k,     0f, -0.4f,   1f,1f,0f,1f,   0f,1f, //#4
       -k,    0f,  0.4f,    -k,     0f,  0.4f,   1f,1f,0f,1f,               1f,0f, //#5
        k,    0f, -0.4f,     k,     0f, -0.4f,   1f,1f,0f,1f,           1f,1f, //#6
        k,    0f,  0.4f,     k,     0f,  0.4f,   1f,1f,0f,1f,               0f,0f, //#7
    -0.4f,    -k,    0f, -0.4f,     -k,    0f,   1f,1f,0f,1f,           0f,1f, //#8 
     0.4f,    -k,    0f,  0.4f,     -k,    0f,   1f,1f,0f,1f,               1f,1f, //#9
    -0.4f,     k,    0f, -0.4f,      k,    0f,   1f,1f,0f,1f,       1f,0f, //#10
     0.4f,     k,    0f,  0.4f,      k,    0f,   1f,1f,0f,1f,               0f,0f, //#11
