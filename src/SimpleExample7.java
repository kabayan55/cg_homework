...
public class SimpleExample7 extends SimpleExampleBase{
  Object3D[] objs;
  PMVMatrix mats;
  Shader shader;
  Shader shader2;
  ...
  public SimpleExample7(){
    objs = new Object3D[2];
    objs[0] = new Grass(4,4,10f,10f); 
    objs[1] = new Tree();
    mats = new PMVMatrix();
    shader = new Shader("resource/spot.vert", "resource/texturespot.frag");
    shader2 = new Shader("resource/spot.vert", "resource/spot.frag");
  ...
  public void init(GLAutoDrawable drawable){
    ...
    gl.glUniform3f(uniformLight, 1f, 0f, 2f);
    gl.glUseProgram(programName2);
    gl.glUniform3f(uniformLight2, 1f, 1f, 2f);
    gl.glUseProgram(0);
  ...
  public void display(GLAutoDrawable drawable){
    ...
    mats.glLoadIdentity();
    mats.glFrustumf(-0.5f,0.5f,-0.5f,0.5f,0.5f,100f);
    ...
    */
    ...
    for(int i=-5;i<=5;i=i+2){
      for(int j=-2;j<=2;j++){
        mats.glPushMatrix();
        mats.glTranslatef(i*0.65f,0.6f+j*1.2f,0);
        mats.glScalef(0.4f,0.4f,1.2f);
        mats.update();
        gl.glUniformMatrix4fv(uniformMat2, 4, false, 
                              mats.glGetPMvMvitMatrixf());
  ...
  public static void main(String[] args){
    SimpleExampleBase t = new SimpleExample7();
    t.start();
  }
