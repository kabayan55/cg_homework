...
public class Cylinder2 extends Object3D{
  ...
  private final int ColorOffset = 0;//Float.SIZE/8*6;
  ...
  public Cylinder2(int num, float radius, float height, boolean smooth,
    ...
    setColor(0, color);
    //    VertexData2[0] = 1.0f;      VertexData2[1] = 1.0f;
    //    VertexData2[1] = 1.0f;      VertexData2[2] = 1.0f;       
    offset=1;
    for(int i=0;i<num+1;i++){ // bottom
      ...
      setColor(j, color);/*
      VertexData2[j*4  ] = 1.0f;
      VertexData2[j*4+1] = 1.0f;
      VertexData2[j*4+2] = 1.0f;
      VertexData2[j*4+3] = 1.0f;*/
    }
