...
public class SimpleExample6 extends SimpleExampleBase{
  Object3D[] objs;
  PMVMatrix mats;
  Shader shader;
  Shader shader2;
  ...
  public SimpleExample6(){
    objs = new Object3D[3];
    objs[0] = new Grass(2,2,8f,6f); 
    objs[1] = new Tree(2f, 1f, 1.2f,new Vec4(0.7f, 0.6f, 0.2f,1.0f),
                       new Vec4(0.3f, 0.9f, 0.4f, 1.0f));
    objs[2] = new Tree();
    mats = new PMVMatrix();
    shader = new Shader("resource/simple.vert", "resource/texture.frag");
  ...
  public void init(GLAutoDrawable drawable){
    ...
    gl.glUniform3f(uniformLight, 10f, 60f, 100f);
    gl.glUseProgram(programName2);
    gl.glUniform3f(uniformLight2, 10f, 60f, 100f);
    gl.glUseProgram(0);

    objs[0].init(gl, mats, programName);
    objs[1].init(gl, mats, programName2);
    objs[2].init(gl, mats, programName2);
  }
  ...
  public static void main(String[] args){
    SimpleExampleBase t = new SimpleExample6();
    t.start();
  }
